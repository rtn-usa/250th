...
rows = [
    ...
    {
        "external_id": slugify("Saratoga Surrender Site"),
        "location_name": "Saratoga Surrender Site",
        "street_address": "Route 4",
        "city": "Schuylerville",
        "region_id": "Saratoga County",
        "latitude": "43.0940",
        "longitude": "-73.5850",
        "subtitle": "The field where 5,895 British soldiers laid down their arms — and changed the world",
        "short_description": "On October 17, 1777, Burgoyne's army surrendered here — the first time an entire British army had capitulated in history. The 19-acre site holds a granite wall, a bronze bas-relief of Trumbull's painting, and a landscape that hasn't changed much since 1777.",
        "description": "On October 17, 1777, British General John Burgoyne surrendered 5,895 men in this field along the Hudson River — the first time an entire British army had capitulated in history. Within months, France recognized the United States, and a colonial rebellion became a global conflict. The 19-acre site is quiet now: a granite wall faces the river, and a bronze bas-relief reproduces John Trumbull's painting The Surrender of General Burgoyne, the original of which hangs in the U.S. Capitol Rotunda. The landscape is remarkably unchanged since 1777. Don't miss: the bronze bas-relief of Trumbull's Surrender of General Burgoyne — then compare it to the original next time you're in the Capitol.",
        "province": "NY",
        "postal_code": "12871",
        "country": "US",
        "phone_number": "",
        "email": "",
        "website": "https://www.nps.gov/sara",
        "website2": "https://saratoga250.com",
        "instagram_link": "",
        "facebook_link": "",
        "twitter_link": "",
        "youtube_link": "",
        ...
        "tags": build_tags("Experience", "National Park", "Saratoga County",
                           "Capital-Saratoga Region", "Revolutionary War Sites",
                           ["History & Heritage", "Self-Guided Tour", "Scenic Views"]),
        "show_on_web": "true",
        "show_on_app": "true"
    },
    {
